...
PARTS = [
    ...
    ("file", "css/12_exselection.css", 472, 628),
    ("file", "css/13_library.css", 629, 649),
    ("file", "css/14_paywall.css", 650, 672),
    ("file", "css/15_animation.css", 673, 689),
    ("file", "css/16_streak.css", 690, 724),
    ("file", "css/17_polish.css", 725, 782),
    ("file", "css/18_style_close.css", 783, 783),
    ("file", "head_close.html", 784, 785),
    ("file", "body_open.html", 786, 854),
    ("file", "body/01_screen1_onboarding.html", 855, 934),
    ("file", "body/02_screen2_volume.html", 935, 1032),
    ("file", "body/03_screen3_review.html", 1033, 1051),
    ("file", "body/04_screen35_meso.html", 1052, 1245),
    ("file", "body/05_screen5_history.html", 1246, 1338),
    ("file", "js/01_open.js", 1339, 1340),
    ("file", "js/02_data.js", 1341, 1374),
    ("file", "js/03_i18n.js", 1375, 2195),
    ("file", "js/04_lang_toggle.js", 2196, 2264),
    ("file", "js/05_injury_joints.js", 2265, 2577),
    ("file", "js/06_pools_svg.js", 2578, 2617),
    ("file", "js/07_guides_meta.js", 2618, 2912),
    ("file", "js/08_rpe_splits.js", 2913, 3066),
    ("file", "js/08b_events.js", 3067, 3227),
    ("file", "js/09_pl_weakpoints_quiz.js", 3228, 3346),
    ("file", "js/10_engines.js", 3347, 4118),
    ("file", "js/11_layer1_volprio.js", 4119, 4618),
    ("file", "js/12_layer3_est_router.js", 4619, 4782),
    ("file", "js/13_screen2_split.js", 4783, 5036),
    ("file", "js/14_screen25_picker.js", 5037, 5341),
    ("file", "js/15_screen3_generate.js", 5342, 5439),
    ("file", "js/16_share_card.js", 5440, 5511),
    ("file", "js/17_screen4_dash.js", 5512, 5547),
    ("file", "js/18_features.js", 5548, 6335),
    ("file", "js/19_wiring.js", 6336, 6509),
    ("file", "js/20_screen5_history.js", 6510, 6712),
    ("file", "js/21_export_import.js", 6713, 6734),
    ("file", "js/22_init.js", 6735, 6771),
    ("file", "js/23_data_sync.js", 6772, 6936),
    ("file", "js/24_custom_exercises.js", 6937, 6965),
    ("file", "js/25_library.js", 6966, 7020),
    ("file", "js/30_exercise_db.js", 7021, 7328),
    ("file", "js/26_close.js", 7329, 7330),
    ("file", "modals.html", 7331, 7379),
    ("file", "js/27_modals_open.js", 7380, 7381),
    ("file", "js/28_modals.js", 7382, 7579),
    ("file", "js/29_close.js", 7580, 7580),
    ("file", "body_close.html", 7581, 7582),
]
