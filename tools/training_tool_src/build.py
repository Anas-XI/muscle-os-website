...
PARTS = [
    ...
    ("file", "js/03_i18n.js", 1335, 2127),
    ("file", "js/04_lang_toggle.js", 2128, 2196),
    ("file", "js/05_injury_joints.js", 2197, 2509),
    ("file", "js/06_pools_svg.js", 2510, 2549),
    ("file", "js/07_guides_meta.js", 2550, 2840),
    ("file", "js/08_rpe_splits.js", 2841, 2989),
    ("file", "js/08b_events.js", 2990, 3150),
    ("file", "js/09_pl_weakpoints_quiz.js", 3151, 3269),
    ("file", "js/10_engines.js", 3270, 4041),
    ("file", "js/11_layer1_volprio.js", 4042, 4532),
    ("file", "js/12_layer3_est_router.js", 4533, 4696),
    ("file", "js/13_screen2_split.js", 4697, 4783),
    ("file", "js/14_screen25_picker.js", 4784, 5087),
    ("file", "js/15_screen3_generate.js", 5088, 5183),
    ("file", "js/16_share_card.js", 5184, 5255),
    ("file", "js/17_screen4_dash.js", 5256, 5291),
    ("file", "js/18_features.js", 5292, 6079),
    ("file", "js/19_wiring.js", 6080, 6253),
    ("file", "js/20_screen5_history.js", 6254, 6456),
    ("file", "js/21_export_import.js", 6457, 6478),
    ("file", "js/22_init.js", 6479, 6515),
    ("file", "js/23_data_sync.js", 6516, 6680),
    ("file", "js/24_custom_exercises.js", 6681, 6709),
    ("file", "js/25_library.js", 6710, 6764),
    ("file", "js/26_close.js", 6765, 6765),
    ("file", "modals.html", 6766, 6814),
    ("file", "js/27_modals_open.js", 6815, 6816),
    ("file", "js/28_modals.js", 6817, 7014),
    ("file", "js/29_close.js", 7015, 7015),
    ("file", "body_close.html", 7016, 7017),
]
