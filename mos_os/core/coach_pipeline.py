...
from mos_os.core.citation_tracker import CitationTracker
from mos_os.core.archetype_matcher import ArchetypeMatcher
from mos_os.core.constraint_engine import (
    build_constraint_graph, constraints_to_modifiers,
)
from mos_os.core.vault_orchestrator import VaultOrchestrator
from mos_os.core.content_generator import (
    generate_program as build_deterministic_content,
    program_to_markdown,
    generate_pillars_section,
)
from mos_os.core.book_engine import BookDecisionEngine, BookEngineResult
...
def _check_llm() -> bool:
    from mos_os.config import LLM_API_KEY, LLM_API_URL, LLM_MODEL
...
def generate_coach_draft(user_id: str) -> dict:
    ...
    from mos_os.core.context_loader import _extract_vault_signals
...
def _generate_section_content(section_id, profile, triage, pillars, pc,
                               ...
                               tracker) -> tuple:
    from mos_os.core.content_generator import _goal_label, _experience_label, _bmi, _calc_bmr, _calc_tdee, _split_label, _training_days_label
...
def export_approved_draft(draft_id: str) -> Optional[str]:
    ...
    from mos_os.core.pdf_renderer import generate_coach_pdf
    ...
    if pdf_path:
        from mos_os.core.pdf_renderer import _add_watermark as _add_wm
