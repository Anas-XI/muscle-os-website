...
from mos_os.config import USERS_DIR, PROGRAMS_DIR, PDFS_DIR, TRACKERS_DIR
...
from mos_os.core.content_generator import generate_program as build_program_content, program_to_markdown
