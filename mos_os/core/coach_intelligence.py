...
from mos_os.core.intake_builder import load_profile, load_supplemental
from mos_os.web.auth import sanitize_user_id, safe_resolve_path
...
def _get_vault_context(query: str, profile: Optional[Dict[str, Any]]) -> str:
    ...
    chunks_text = []
    try:
        from mos_os.core.vault_rag import VaultIndexer, INDEX_DIR
    ...
    try:
        from mos_os.core.vault_graph import INDEX_DIR as GRAPH_INDEX_DIR
        import pickle
...
def build_coach_system_prompt(user_id: str, query: str = "") -> str:
    ...
    if injuries:
        ...
        try:
            from mos_os.core.biomechanics_engine import get_injury_override
            for inj in injuries:
    ...
    has_mh_flag = False
    try:
        from mos_os.core.mental_health_flags import has_active_mental_health_flag
