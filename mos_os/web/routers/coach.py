...
from mos_os.core.coach_pipeline import (
...
from mos_os.web.auth import require_api_key, sanitize_user_id, safe_resolve_path
...
async def api_update_coach_notes(draft_id: str, req: CoachNotesRequest):
    ...
    from mos_os.core.coach_pipeline import DRAFTS_DIR
