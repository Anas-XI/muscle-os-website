...
from mos_os.core.strength_engine import calculate_1rm, get_strength_standard, prescribe_working_load
from mos_os.core.biomechanics_engine import get_injury_override, suggest_exercise_substitutions
from mos_os.core.nutrition_calculator import calculate_tdee, calculate_macro_split
from mos_os.core.supplement_engine import analyze_supplement_stack
from mos_os.core.circadian_engine import calculate_circadian_schedule
from mos_os.core.cardio_engine import generate_cardio_prescription
from mos_os.core.posture_engine import evaluate_posture
from mos_os.core.female_physiology_engine import get_cycle_phase_recommendations
from mos_os.core.plant_protein_engine import optimize_plant_protein
...
def api_execute_coach_action(req: CoachActionRequest):
    from mos_os.core.coach_actions import execute_coach_action
...
def api_get_coach_modifications(user_id: str):
    from mos_os.core.coach_actions import get_program_modifications
    return {
        "user_id": user_id,
...
def api_audit_program(req: ProgramAuditRequest):
    from mos_os.core.program_auditor import audit_user_program
