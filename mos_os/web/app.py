...
from mos_os.config import DATA_ROOT, LLM_API_KEY, LLM_API_URL, LLM_MODEL, TRACKERS_DIR
from mos_os.core.intake_builder import load_profile, save_profile, build_profile
from mos_os.core.program_generator import generate_program
from mos_os.core.tracker_renderer import generate_tracker_html
from mos_os.core.coach_intelligence import generate_coach_response, stream_coach_response, get_chat_history
from mos_os.web.auth import require_api_key, sanitize_user_id, safe_resolve_path, get_api_key
...
from mos_os.web.routers.arbitrate import router as arbitrate_router
app.include_router(arbitrate_router)
from mos_os.web.routers.supplemental import router as supplemental_router
app.include_router(supplemental_router)
from mos_os.web.routers.coach import router as coach_router, load_coach_html
app.include_router(coach_router)
from mos_os.web.routers.intelligence import router as intelligence_router
